"use strict";var Timetable=function(){
    this.scope={
...
,function(){
    ...
    function i(t,e){
        ...
        function s(t){
            var e=t<10?"0":"";return e+t+":00"}
        Timetable.prototype={
            setScope:function(e,n){if(!t(e,n))throw new RangeError("Timetable scope should consist of (start, end) in whole hours from 0 to 23");
                return this.scope.hourStart=e,
            ...
            addLocations:function(t){
                ...
                var n=this.locations;if(!e())throw new Error("Tried to add locations in wrong format");
            ...
            ,addEvent:function(t,e,n,o,a){
                ...
                return this.events.push({name:t,location:e,startDate:n,endDate:o,options:c?a:void 0}),this
            }
        }
        ,Timetable.Renderer.prototype={
            draw:function(t){function e(t){
            ...
            function i(t){
                for(var e=t.appendChild(document.createElement("header")),n=e.appendChild(document.createElement("ul")),o=!1,r=!1,i=f.scope.hourStart;!o;){
                    ...
                    c.className="time-label",
                            c.textContent=s(i),
                            i!==f.scope.hourEnd||f.scope.hourStart===f.scope.hourEnd&&!r||(o=!0),
                            24===++i&&(i=0,r=!0)
                }
            }
            function l(t){
            ...
            function u(t,e){
                for(var n=0;n<f.events.length;n++){
                    var o=f.events[n];o.location===t&&d(o,e)
                }
            }
            function d(t,e){
                var n,o,r=void 0!==t.options,i=!1;
                r&&(n=void 0!==t.options.url,o=void 0!==t.options["class"],
                i=void 0!==t.options.data);
                var a=n?"a":"span",
                ...
                c.className=o?"time-entry "+t.options["class"]:"time-entry",
                        c.style.width=h(t),c.style.left=m(t),
                        s.textContent=t.name}function h(t){
                        var e=t.startDate,n=t.endDate,
                                o=p(e,n);return o/v*100+"%"
                    }
                    function p(t,e){
