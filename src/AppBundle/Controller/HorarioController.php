...
class HorarioController extends Controller
{
   ...
   /* public function showAction(Horario $horario)
     ...
     *
     * @Route("/{idhorario}/edit", name="horario_edit")
     * @Method({"GET", "POST"})
     */
     ...
     *
     * @Route("/{idhorario}", name="horario_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Horario $horario)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('horario_delete', array('idhorario' => $horario->getIdhorario())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
