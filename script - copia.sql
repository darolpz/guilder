...
-- Table `mydb`.`Materia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `prueba`.`Materia` (
...
-- Table `mydb`.`Comision`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `prueba`.`Comision` (
...
-- Table `mydb`.`Horario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `prueba`.`Horario` (
...
-- Table `mydb`.`Token`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `prueba`.`Token` (
